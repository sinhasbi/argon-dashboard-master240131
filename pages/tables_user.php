...
<body class="g-sidenav-show   bg-gray-100">
  ...
  <main class="main-content position-relative border-radius-lg ">
    ...
    foreach ($result as $user):
      ...
      <!-- 20241112 利用BOOTSTRAP MODAL -->
      <!-- id="exmapleModal" ->  id="confirmModal"-->
            ...
            <div class="card mb-4">
              <div class="card-header pb-0">
                <div class="d-flex justify-content-lg-between">
                  ...
                  <div class="col-auto">
                    <a class="btn btn-primary" href="../pages/tables.php" role="button"><i
    ...
    ?>
            ...
            <div class="container">
              ...
              <div class="py-2 d-flex justify-content-between">
                <a class="btn btn-primary" href="user-edit.php?id=<?= $row["id"] ?>" role="button">
                  <i class="fa-solid fa-user-pen fa-fw"></i></a>
                <!-- 刪除按鈕 -->
                <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#confirmModal" role="button">
